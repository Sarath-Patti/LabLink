...
class TransportConfig:
    ...
    tcp_default_timeout_sec: float = 5.0
    tcp_connect_retry_attempts: int = 3
    serial_default_baudrate: int = 9600
    serial_default_timeout_sec: float = 2.0
...
class DatabaseConfig:
    ...
    max_connections: int = field(default_factory=lambda: int(os.getenv("LABLINK_DB_MAX_CONN", "10")))


@dataclass
class SimulatorConfig:
    """Configuration for instrument software simulators."""
    enabled: bool = field(default_factory=lambda: os.getenv("LABLINK_SIMULATORS_ENABLED", "false").lower() == "true")
    tcp_simulator_port: int = field(default_factory=lambda: int(os.getenv("LABLINK_SIM_TCP_PORT", "9001")))
...
class ExecutionConfig:
    ...
    max_parallel_tests: int = field(default_factory=lambda: int(os.getenv("LABLINK_PARALLEL_TESTS", "1")))
...
class LabLinkConfig:
    ...
    def __init__(
        ...
        instruments: Optional[InstrumentConfig] = None,
        database: Optional[DatabaseConfig] = None,
        simulators: Optional[SimulatorConfig] = None,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "LabLinkConfig":
        ...
        return cls(
            ...
            instruments=InstrumentConfig(**instrument_data) if instrument_data else InstrumentConfig(),
    ...
    def to_dict(self, mask_secrets: bool = True) -> Dict[str, Any]:
        ...
        db_dict = {
            ...
            "password": "***MASKED***" if mask_secrets and self.database.password else self.database.password,
        ...
        return {
            ...
            "instruments": {
                "scpi_default_read_termination": repr(self.instruments.scpi_default_read_termination),
                "scpi_default_write_termination": repr(self.instruments.scpi_default_write_termination),
